...
bridge_steel_e_modulus = theta[0]
bridge_steel_density = theta[1]
tower_concrete_e_modulus = theta[2]
cable_steel_e_modulus = theta[3]
...
skrastag_bsp_file[30405] = str(bridge_steel_e_modulus) + ", 0.3\n"
skrastag_bsp_file[30403] = str(bridge_steel_density) + "\n"
...
viadukt_bsp_file[26284] = str(bridge_steel_e_modulus) + ", 0.3\n"
viadukt_bsp_file[26282] = str(bridge_steel_density) + "\n"
