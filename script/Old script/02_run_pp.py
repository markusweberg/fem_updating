...
ax = plt.axes(projection='3d')
ax.set_title('Final sensitivity matrix (Natural frequencies)', fontweight='bold')
...
ax = plt.axes(projection='3d')
ax.set_title('Final sensitivity matrix (Mode shapes)', fontweight='bold')
...
MAC_updated = info['MAC_updated']['MAC_updated15']
...
MMI_updated = info['MMI_updated']['MMI_updated15']
...
# Save
plt.savefig(fig_folder + 'fig8' + fig_format1)
plt.savefig(fig_folder + 'fig8' + fig_format2)
...
# Save
plt.savefig(fig_folder + 'fig9' + fig_format1)
plt.savefig(fig_folder + 'fig9' + fig_format2)
