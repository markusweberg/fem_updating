...
bridge_steel_e_modulus = 2.1E+11
bridge_steel_density = 7850
tower_concrete_e_modulus = 0.27E+11
cable_steel_e_modulus = 1.6E+11
...
# Parameter list
theta_0 = np.array([bridge_steel_e_modulus, bridge_steel_density, tower_concrete_e_modulus, cable_steel_e_modulus,
...
for itr in range(iterations):
    ...
    lower_allowable_theta = np.array([1.5E+11, 6000, 0.15E+11, 1.5E+11, 0, 0, 0, 0, 0])
    upper_allowable_theta = np.array([3.0E+11, 10000, 0.35E+11, 3.0E+11, 1E+14, 1E+14, 1E+16, 1E+16, 1E+16])

    # Local parameter bounds
    lb_local = np.array([0.95, 0.95, 0.95, 0.95, 0.80, 0.80, 0.80, 0.80, 0.80])
    ub_local = np.array([1.05, 1.05, 1.05, 1.05, 1.20, 1.20, 1.20, 1.20, 1.20])
